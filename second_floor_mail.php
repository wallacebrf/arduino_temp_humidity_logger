...
//***************************************
$database_column="My-Database";
$servername = "127.0.0.1:3307";
$username = "root";
$password = "password";
$dbname = "home_temp";
$message_subject='Second Floor Temperature Monitor';
$message_body='The average second floor temperature has dropped below '.$min_temp.' degrees</b><br>Check the status of the cooling system';
$message_altbody='The average second floor temperature has dropped below '.$min_temp.' degrees. Check the status of the cooling system';
